...
const CONVERSATION_OUTCOME = [
  { label: 'Resueltas automáticamente', value: 68, color: '#7c3aed' },
  { label: 'Requieren seguimiento manual', value: 20, color: '#a855f7' },
  { label: 'Información pendiente', value: 12, color: '#c084fc' }
]
  ...
  return (
    <div className="min-h-dvh bg-gradient-to-b from-purple-50 via-white to-white">
      ...
      <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col px-4 pb-12 pt-8">
        <div className="mx-auto w-full max-w-4xl overflow-hidden rounded-3xl border border-purple-100 bg-white/90 shadow-xl backdrop-blur">
          <div className="border-b border-purple-100 bg-white/60 px-8 py-8 text-center">
            <h2 className="text-xl font-semibold text-gray-900">
              Métricas del asistente virtual
            </h2>
            <p className="mt-3 text-sm text-gray-600 md:text-base">
              Esta vista utiliza datos estáticos como placeholder mientras se conecta a la API real.
            </p>
          </div>
          ...
          <section className="grid gap-6 px-8 py-8 md:grid-cols-[1.4fr,1fr]">
            <article className="rounded-2xl border border-purple-100 bg-white/80 p-6 shadow-sm">
              ...
              <p className="mt-1 text-xs text-gray-500 md:text-sm">
                Ranking de consultas más repetidas durante la última semana.
              </p>
          ...
          <section className="grid gap-6 px-8 pb-6 md:grid-cols-2">
            ...
            <article className="rounded-2xl border border-purple-100 bg-white/80 p-6 shadow-sm">
              ...
              <p className="mt-1 text-xs text-gray-500 md:text-sm">
                Distribución estimada de cómo finalizan las interacciones.
              </p>
        ...
        <p className="mx-auto mt-8 max-w-3xl text-center text-sm text-gray-500">
          Próximamente podrás visualizar estas métricas en tiempo real provenientes del servicio de
          RAG.
        </p>
      </main>
    </div>
